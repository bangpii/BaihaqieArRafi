    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            window.addEventListener('message', (event) => {
                if (event.data && event.data.type === 'particle-mouse') {
...
const PARTICLE_DRIFT_DEFINITION = {
...
export default function ParticleDrift({
  ...
  const background = resolveBackground(PARTICLE_DRIFT_DEFINITION.background, resolvedMode);
